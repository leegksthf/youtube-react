...
const VideoItem = memo(({ video, video: { snippet }, onVideoClick, display, flex }) => {
    const displayType = display === "list" ? styles.list : styles.grid;
    const displayFlex = flex === "column" ? styles.column : styles.row;
    ...
    return (
      ...
      >
        <div className={`${styles.video} ${displayFlex}`}>
          <img
